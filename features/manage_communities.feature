Feature: Manage communities
  ...
  Scenario: Review Communities
    ...
    And I see the names of any requested communities at the top of the list
    And I see a link to edit each community
    And I see a button to delete any community that does not have any active businesses or users
