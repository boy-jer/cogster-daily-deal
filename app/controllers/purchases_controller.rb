class PurchasesController < ApplicationController
  ...
  def create
    ...
    if @purchase.save
      redirect_to account_path, :notice => "Thank you for your purchase! You have ${@purchase.current_redemption} in Cogster Cash available right now for use at @business.name."
    else
